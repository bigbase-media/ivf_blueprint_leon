...
class BPScale(CBlueprintBase):

    # input: https://videofactory.oss-cn-shanghai.aliyuncs.com/ios/vSCALEideo/mv_7.mp4
    # output: http://test-v.oss-cn-shanghai.aliyuncs.com/hypnos-blueprint/output-10565-680188.mp4
    def __init__(self, user_element, width=720, height=1280, element_duration=None, action_configDict=None,
                 element_configDict=None):
        super(BPScale, self).__init__("scale")
        self._width = width
        self._height = height
    ...
    def newLevel_Func(self, configDict):
        ...
        baseActionDict = {
            ...
            "endPos": "0.5,0.5,1,1",
            "subactions": ["scale"],
            "scaleConfig": {"startScale": "1.0", "endScale": "0.5"}
        }
...
def test_effect():
    ...
    videoDuration = 5000
    rotateVideo = make_Video(BPScale, userVideo, element_duration=videoDuration)
    print(rotateVideo)
