...
class BPReflect(CBlueprintBase):
    ...
    def newLevel_Func(self, configDict):
        ...
        baseActionDict = {
            ...
            "subactions": ["reflect"],
            "reflectConfig":{"startTime": 0, "endTime":self._element_duration}
        }
        kwargs = {
            'element': configDict['elementNames']
        }
...
def test_effect():
    ...
    rotateVideo = make_Video(BPReflect, userVideo, element_duration=videoDuration)
    print(rotateVideo)
